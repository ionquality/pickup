...
class Helpers
{
    ...
    {
        if ($date_string) {
            $return_date = date("m/d/Y", strtotime($date_string));
        } else {
            $return_date = NULL;
        }
    ...
    {
        if ($date_string) {
            $return_date = date("F d, Y", strtotime($date_string));
        } else {
            $return_date = NULL;
        }
    ...
    public static function getDateTimeString($date_string)
    {
        ...
        if ($date_string) {
            $return_date = date("m/d/Y h:i A", strtotime($date_string));
    ...
    public static function getTimeString($date_string)
    {
        if ($date_string) {
            $return_date = date("h:i A", strtotime($date_string));
        } else {
            $return_date = NULL;
        }
